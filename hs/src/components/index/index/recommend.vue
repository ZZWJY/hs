<template>
  <div class="recom">
    ...
    <div class="single-img">
      <router-link to="/">
        <img src="http://127.0.0.1:3000/img/index/refer/router.png" />
        <img />
      </router-link>
    </div>
...
export default {
  data() {
    return {
      ...
      minutes: "00",
      carousel: [
        "广州市李先生 以￥2599 喜提红米 K20 Pro 6GB 128GB 碳纤黑 全网通fsdfrdsfs",
        "深圳市廖女士 以￥1099 喜提红米 Note7 4GB+64GB 梦幻蓝",
        "北京市杨女士 以￥4188 喜提华为 P30 8GB 128GB 天空之境",
        "天津市王先生 以￥1099 喜提红米 Note 7 4GB 64GB 暮光金 全网通",
        "广州市李先生 以￥2599 喜提红米 K20 Pro 6GB 128GB 碳纤黑 全网通fsdfrdsfs"
      ]
    };
  },
  ...
  methods: {
    ...
    time() {
      setInterval(() => {
        ...
        this.minutes =
          residueM.toString().length > 1 ? residueM : "0" + residueM;
      }, 1000);
    },
    carsou() {
...
.evalImgs p:nth-child(3),
.evalImgs p:nth-child(4) span {
  color: #111;
  font-weight: 700;
  font-size: 1rem;
}
...
.activity div:first-child img,
.benefit img,
.partner img {
  width: 100%;
}
.activity div:last-child img,
.understand img {
  width: 50%;
}
</style>
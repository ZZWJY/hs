<template>
  <div>
    ...
    <div class="trade_header">
      <div class="headers">
        <router-link to="/evaluate" slot="left">
    ...
    <div>
      ...
      <div class="tabs_item2" v-show="number==2">
        ...
        <mt-field label="手机号" placeholder="请输入手机号" class="phone"></mt-field>
        <p>上门信息</p>
        <mt-field placeholder="搜索您的小区、大厦、街道名称"  class="phone"></mt-field>
      ...
      <div class="tabs_item3" v-show="number==3">
        ...
        <div class="inps_item">
          <mt-field label="联系人" placeholder="请输入联系人姓名"  class="phone"></mt-field>
          <mt-field label="手机号" placeholder="请输入手机号" class="phone"></mt-field>
        </div>
        <!-- 速递 -->
        <div class="inps">
...
export default {
  ...
  methods: {
    ...
    fode(){
      var ofnew=document.querySelector(".ofnew-module")
      ofnew.style.display='none'
    }
  },
  created() {
